...
BetterVRCX to aplikacja pomocnicza dla VRChat, która dostarcza informacje i pomoc w różnorodnych czynnościach związanych z VRChat, w wygodniejszy sposób niż klient gry (PC i VR) czy strona internetowa. Zawiera sporo ciekawych funkcji opisanych poniżej.
...
- :electric_plug: Automatycznie uruchamiaj aplikacje podczas startu VRChat
    - Ustaw, aby BetterVRCX uruchamiał inne aplikacje, gdy włączysz VRChat.
    - Na przykład, możesz ustawić, aby BetterVRCX uruchamiał aplikację OSC lub modulacji głosu, gdy włączysz VRChat.
...
- :bell: Obserwuj i odpowiadaj na powiadomienia
    - Możesz wysyłać oraz otrzymywać zaproszenia do instancji i znajomych w BetterVRCX, a także widzieć informacje o tych instancjach.
...
- :skull: Automatycznie uruchom grę i dołącz do ostatniej instancji po crashu VRChat
...
- Zobacz [Poradnik budowania z kodu źródłowego](https://github.com/vrcx-team/VRCX/wiki/Building-from-source) po instrukcję jak skompilować BetterVRCX samemu.
- Sprawdź jak uruchomić BetterVRCX na Linuxie [tutaj](https://github.com/vrcx-team/VRCX/wiki/Running-VRCX-on-Linux)
...
<img src="../images/Preview/Login.png" alt="logowanie">

<h3>Strona główna</h3>

<img src="../images/Preview/Home.png" alt="strona główna">
...
<img src="../images/Preview/Userinfo-Me.png" alt="ja">

<h4>Znajomy</h4>

<img src="../images/Preview/Userinfo-Friend.png" alt="znajomy">

<h3>Świat</h3>

<h4>Instancja</h4>

<img src="../images/Preview/World-Instance.png" alt="instancja">

<h4>Informacje</h4>

<img src="../images/Preview/World-Info.png" alt="informacje">

<h3>Dodatki</h3>

<h4>Tapeta strony głównej</h4>

<img src="../images/Preview/Addon-Home.png" alt="tapeta strony głównej">

<h4>Tło profilu</h4>

<img src="../images/Preview/Addon-Profile.png" alt="tło profilu">

<h4>Kopia zapasowa Google Drive</h4>

<img src="../images/Preview/Addon-GDrive.png" alt="kopia zapasowa Google Drive">

</div>

## Czy BetterVRCX łamie TOS VRChatu?

**Nie.**

BetterVRCX to zewnętrzne narzędzie, które używa API VRChatu do oferowania swoich funkcji.
...
BetterVRCX nie jest wspierany przez VRChat i nie odzwierciedla poglądów ani opinii VRChat lub kogokolwiek oficjalnie zaangażowanego w produkcję lub zarządzanie własnoścami VRChatu. VRChat i wszystkie powiązane właściwości są znakami towarowymi lub zastrzeżonymi znakami towarowymi VRChat Inc. VRChat © VRChat Inc.
