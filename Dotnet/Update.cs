...
namespace VRCX
{
    public class Update
    {
        ...
        private static readonly string VrcxSetupExecutable = Path.Join(Program.AppDataDirectory, "VRCX-Redesign_Setup.exe");
        ...
        {
            if (Process.GetProcessesByName("VRCX-Redesign_Setup").Length > 0)
                Environment.Exit(0);
