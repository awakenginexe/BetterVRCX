...
# <img src="./images/VRCX.ico" width="64" height="64"> </img> VRCX Redesign

Unofficial redesign fork of VRCX.

This project is not developed by, endorsed by, or affiliated with vrcx-team.
Original project: https://github.com/vrcx-team/VRCX

Licensed under the MIT License. Original copyright belongs to the VRCX contributors.
...
Download and install the latest installer (`VRCX-Redesign_Setup.exe`) from this fork's releases.
...
<img src="./images/preview/feed.png" alt="Feed preview">

<h3>Game Log</h3>

<img src="./images/preview/game-log.png" alt="Game Log preview">
</div>
