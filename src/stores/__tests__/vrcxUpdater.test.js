...
describe('useVRCXUpdaterStore.setAutoUpdateVRCX', () => {
    beforeEach(async () => {
        ...
        globalThis.AppApi = {
            GetVersion: vi
                .fn()
                .mockResolvedValue('BetterVRCX v3.1.0 B 2026.08.17'),
        ...
        mocks.webApiService.execute.mockResolvedValue({
            ...
            data: JSON.stringify({
                tag_name: 'v3.1.0',
                name: 'BetterVRCX v3.1.0',
                body: null,
                published_at: '2026-08-16T10:45:00Z',
                assets: [
                    {
                        name: 'BetterVRCX_Setup_v3.1.0.exe',
                        state: 'uploaded',
                        browser_download_url:
                            'https://github.com/awakenginexe/BetterVRCX/releases/download/v3.1.0/BetterVRCX_Setup_v3.1.0.exe',
                        size: 200000000,
                        digest: 'sha256:abcd'
                    }
                ]
    ...
    test('checkForVRCXUpdate succeeds and sets latestAppVersion even with null release body', async () => {
        ...
        expect(store.latestAppVersion).toBe('BetterVRCX v3.1.0');
